...
hi Constant	    guifg=#d787d7 gui=none

"hi String       guifg=#64ce3e gui=none
hi String       guifg=#00d75f gui=none
"TamTam hi String       guifg=#00d787 gui=none
"ABitDark hi String       guifg=#00af5f gui=none

"GOLD hi Statement    guifg=#f8de33 gui=none
"VIOLET hi Statement    guifg=#cf7bff gui=none
hi Statement    guifg=#ffaf87 gui=none

"DoChoe hi Entity       guifg=#fa6513 gui=none
hi Entity       guifg=#ff6666 gui=none
"hi Entity       guifg=#ff5f5f gui=none
