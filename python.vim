...
"Hieu
"syn keyword pythonStatement  range
"syn keyword pythonStatement  len
"syn keyword pythonStatement  raw_input apply filter map reduce
...
"Hieuif exists("python_highlight_builtins") && python_highlight_builtins != 0
